...
class Momentum:
    def __init__(self, num_features=1, alpha=0.7, beta=0.9):
...
class LogR:
    ...
    def __init__(self, num_features=1, optimizer=Momentum(), alpha=0):
    ...
    def fit(self, X, y_true, grad_tol=0.0001, n_iters=40000):
        grad_norm = np.inf
        n_iter = 0
        losses = []
